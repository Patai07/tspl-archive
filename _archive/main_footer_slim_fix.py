...
# Refined Slim Footer for Main Pages
# - 3 columns for minimal height
# - Supporter names side-by-side but outside capsule
...
for filename in ['index.html', 'about.html', 'methodology.html', 'archive.html']:
