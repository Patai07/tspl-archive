...
# New slim footer for process pages
# We only want to replace from the <footer> tag onwards.

new_footer_html = """  <footer class="bg-sila-jaruek text-gray-400 pt-10 md:pt-14 pb-8 relative overflow-hidden mt-20">
...
for filename in ['capture.html', 'decode.html', 'digitize.html']:
    ...
    # Find where <footer> starts and replace it completely
    # We'll search for <footer to </footer>
